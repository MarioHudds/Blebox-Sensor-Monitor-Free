...
Projekt garażowy open-source pozwalający na ciągłe wyświetlanie danych z czujników ekosystemu Blebox (tempSensor, humiditySensor, multiSensor) na klasycznym ekranie LCD 16x2 lub 24x3.
...
* **Wyświetlacz LCD 16x2 lub 24x4 dla odpowiedniego kodu (I2C, adres 0x27):**
  * `SDA` -> GPIO 10
  * `SCL` -> GPIO 20
